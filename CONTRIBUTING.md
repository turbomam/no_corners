# Contributing to no_corners

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to no_corners. 
...
The no_corners team strives to create a
...
Please use our [Issue Tracker](https://github.com/turbomam/no_corners/issues/) for reporting problems with the ontology. 
